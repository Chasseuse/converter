...
function App() {
    ...
    function handleFromNumberChange(e: React.ChangeEvent<HTMLInputElement>) {
        setNumber(parseFloat(e.target.value))
        setNumberInFromMoney(true)
    }

    function handleToNumberChange(e: React.ChangeEvent<HTMLInputElement>) {
        setNumber(parseFloat(e.target.value))
        setNumberInFromMoney(false)
    }

    function handleChangeFromMoney(e: React.ChangeEvent<HTMLSelectElement>) {
    ...
    function handleChangeToMoney(e: React.ChangeEvent<HTMLSelectElement>) {
